  ...
  <div class="space-y-6">
    <div class="card">
      ...
      <div class="card-body grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <FormField
          ...
          hint="Identificador único, apenas letras, números e hífens."
        >
        ...
        <FormField
          label="Acesso até"
          :error="form.errors.access_until"
          hint="Deixe em branco para acesso sem data de expiração."
        >
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p v-if="form.errors.modules" class="form-error mt-2">
          {{ form.errors.modules }}
        </p>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body space-y-4">
        ...
        <div
          v-if="form.whatsapp_provider === 'dichat'"
          class="grid grid-cols-1 gap-4 sm:grid-cols-2"
        >
          <FormField
            label="URL base"
            :error="form.errors['whatsapp_config.base_url']"
            hint="Servidor da instância dichat, ex.: api11, api12."
          >
            <TextInput
              v-model="form.whatsapp_config.base_url"
              placeholder="https://api11.dichat.com.br"
            />
          </FormField>

          <FormField
            label="Token"
            :error="form.errors['whatsapp_config.token']"
            hint="Token da conexão (Bearer) do painel dichat."
          >
    ...
    <div v-if="showAdminFields" class="card">
      ...
      <div class="card-body grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <FormField
          ...
          hint="O administrador deverá alterá-la no primeiro acesso."
        >
